...
public class FXMLDocumentController implements Initializable{
    ...
    @FXML
    void mostrarViewSelecionada(ActionEvent event) {
...
private void modificarProdutoRestaurante() {
    try {
        ...
        showAlert("Sucesso", "Produto alterado com sucesso!");
    ...
    void adicionarProdutoCarrinho(ActionEvent event) {
        ...
        custoTotalLabel.setText(precoAtual + " R$");
    ...
    void handleCriarContaCliente(ActionEvent event) {
     if (BancoDeDados.encontrarUsuario(loginDonoTextField.getText()) == null) {
         try {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        listaProdutos.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                precoProdutoLabel.setText(produto.getPreco() + " R$");
